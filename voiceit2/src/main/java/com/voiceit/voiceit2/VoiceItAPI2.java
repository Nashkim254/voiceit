...
public class VoiceItAPI2 {
    ...
    public void encapsulatedVoiceVerification(Activity activity, String userId, String contentLanguage, String phrase, final JsonHttpResponseHandler responseHandler) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("key_a682a40728464bd6bfb563b7237cd74d", this.apiKey);
        bundle.putString("tok_497be67e778241d18de68eb7fe576d24", this.apiToken);
        bundle.putString("usr_e14324bf532547cba99d735aca29d394", userId);
        bundle.putString("en-US", contentLanguage);
        bundle.putString("Never forget tomorrow is a new day", phrase);
        intent.putExtras(bundle);
        activity.startActivity(intent);
        activity.overridePendingTransition(0, 0);
