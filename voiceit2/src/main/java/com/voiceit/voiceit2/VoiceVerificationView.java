...
public class VoiceVerificationView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle != null) {
            mVoiceIt2 = new VoiceItAPI2(bundle.getString("key_a682a40728464bd6bfb563b7237cd74d"), bundle.getString("tok_497be67e778241d18de68eb7fe576d24"));
            mUserId = bundle.getString("usr_e14324bf532547cba99d735aca29d394");
            mContentLanguage = bundle.getString("en-US");
            mPhrase = bundle.getString("Never forget tomorrow is a new day");
        }
